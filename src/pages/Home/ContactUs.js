...
const ContactUs = () => {
    return (
        <section  className="my-14 bg-[url('/src/assets/images/appointment.png')]">
            <div  className='text-center'>
                <h4  className='text-primary text-xl font-bold'>Contact Us</h4>
                <h2  className='text-3xl font-semi-bold text-white'>Stay connected with us</h2>
                <form  className="w-full max-w-lg mx-auto my-5">
                    <div  className="flex flex-wrap -mx-3 mb-6">
                        <div  className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <input  className="appearance-none block w-full bg-gray-200 text-white border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" placeholder="Jane" />
                        </div>
                    ...
                    <button  className="shadow bg-teal-400 hover:bg-teal-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded mb-7" type="button">
                        Send
                    </button>
                </form>
            </div>
